...
def test_delete_scan_trigger_deletes_firestore_and_output_files(create_user_in_emulator, get_storage_bucket_name):
    """
    ...
    scan_doc_ref.set({
        "user": "user_for_scan_test",
        "step": "step_for_scan_test",
        "status": 2,
        "progress": 100
    })
