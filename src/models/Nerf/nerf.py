...
if __name__ == '__main__':
    ...
    # training_dataset = torch.from_numpy(np.load('my_video.pkl', allow_pickle=True))
    # testing_dataset = torch.from_numpy(np.load('My_video.pkl', allow_pickle=True))

    training_dataset = torch.from_numpy(images)
    testing_dataset = torch.from_numpy(images)
